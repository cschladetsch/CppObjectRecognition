...
void CreateAndTestImage(const std::string& testName, Image testImage, const std::string& description) {
    ...
    ColorImage colorImage = ImageProcessor::CreateColorImage(testImage, rectangles);
...
Image CreateTrianglesOnlyImage() {
    ...
    // Add triangles
    ImageProcessor::DrawFilledTriangle(image, Point(60, 60), Point(120, 60), Point(90, 20), 255);
    ImageProcessor::DrawFilledTriangle(image, Point(180, 100), Point(240, 140), Point(140, 140), 255);
    ImageProcessor::DrawFilledTriangle(image, Point(300, 50), Point(370, 50), Point(335, 120), 255);
    ImageProcessor::DrawFilledTriangle(image, Point(100, 180), Point(160, 220), Point(70, 240), 255);
    ImageProcessor::DrawFilledTriangle(image, Point(280, 180), Point(350, 200), Point(310, 260), 255);
...
Image CreateMixedShapesImage() {
    ...
    ImageProcessor::DrawFilledTriangle(image, Point(300, 200), Point(370, 200), Point(335, 150), 255);
    ImageProcessor::DrawFilledTriangle(image, Point(500, 350), Point(570, 390), Point(480, 400), 255);
...
Image CreateComplexSceneImage() {
    ...
    ImageProcessor::DrawFilledTriangle(image, Point(200, 350), Point(280, 350), Point(240, 300), 255);
    ImageProcessor::DrawFilledTriangle(image, Point(550, 150), Point(620, 180), Point(530, 200), 255);
    ImageProcessor::DrawFilledTriangle(image, Point(700, 450), Point(770, 480), Point(720, 520), 255);
...
int main() {
    ...
    CreateAndTestImage("circles_only", circlesImage, "Multiple circles - should detect 0 rectangles");
    
    // Test 2: Only triangles (should detect 0 rectangles)
    Image trianglesImage = CreateTrianglesOnlyImage();
    CreateAndTestImage("triangles_only", trianglesImage, "Multiple triangles - should detect 0 rectangles");
    
    // Test 3: Only rectangles (should detect all rectangles)
    Image rectanglesImage = CreateRectanglesOnlyImage();
    CreateAndTestImage("rectangles_only", rectanglesImage, "Multiple rectangles - should detect all rectangles");
    ...
    std::cout << "Check the generated .png files to see the results!" << std::endl;
