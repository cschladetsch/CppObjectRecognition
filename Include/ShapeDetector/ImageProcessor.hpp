...
struct ColorPixel {
  unsigned char r, g, b;
  ColorPixel(unsigned char red = 0, unsigned char green = 0,
...
public:
  ...
  static void SavePPMImage(const ColorImage &image,
                           const std::string &filepath);
  static void SavePNGImage(const ColorImage &image,
                           const std::string &filepath);
  ...
  static void DrawCircle(Image &image, int centerX, int centerY, int radius,
                         int color = 255);
  static void DrawFilledCircle(Image &image, int centerX, int centerY,
                               int radius, int color = 255);
  static void DrawTriangle(Image &image, const Point &p1, const Point &p2,
                           const Point &p3, int color = 255);
  static void DrawFilledTriangle(Image &image, const Point &p1, const Point &p2,
                                 const Point &p3, int color = 255);
  static void DrawEllipse(Image &image, int centerX, int centerY, int radiusX,
                          int radiusY, double angle = 0.0,
                          int color = 255); // angle in radians
  static void DrawFilledEllipse(Image &image, int centerX, int centerY,
                                int radiusX, int radiusY, double angle = 0.0,
                                int color = 255); // angle in radians
  static void CreateRotatedRectangle(Image &image, int centerX, int centerY,
...
private:
  ...
  static void
  FillRotatedRectangle(Image &image,
                       const std::vector<std::pair<int, int>> &corners);
  static bool IsPointInPolygon(int x, int y,
                               const std::vector<std::pair<int, int>> &polygon);
  static std::vector<Point>
  CleanupRectangleCorners(const std::vector<Point> &corners);
  ...
  static void DrawColorLine(ColorImage &image, const Point &p1, const Point &p2,
